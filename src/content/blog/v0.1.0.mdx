...
Download [v0.1.0](https://github.com/zamm-dev/zamm/releases/tag/v0.1.0) for:

- <a href="https://github.com/zamm-dev/zamm/releases/download/v0.1.0/zamm_0.1.0_x64-setup.exe" download>Windows</a>
- <a href="https://github.com/zamm-dev/zamm/releases/download/v0.1.0/zamm_0.1.0_universal.dmg" download>Mac</a>
- <a href="https://github.com/zamm-dev/zamm/releases/download/v0.1.0/zamm_0.1.0_amd64.AppImage" download>Linux</a>
